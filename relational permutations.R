...
#In V0.1,longer lists(>3 elements) do not iterate through all possible combinatorially derived relations yet.
#   this issue is manually addressed by recursing through part of the v0.2 code until the checksum reaches zero.
#   This recursion has not been implemented in V0.1 since V0.2 outputs the same and more.
#   Currently leaving V0.1 on here until V0.2 no longer has to be manually iterated.
...
##The function below has not be attempted yet because I got the functionality mostly working above.  
#   If anyone wants to integrate what is performed between the u assignment and diff.join above into this,
#     that would be amazing
relTrain<- function(a){
  #This function will do all of the above such that it can be fed a simple list of relational statements 
  # and output the master table x
